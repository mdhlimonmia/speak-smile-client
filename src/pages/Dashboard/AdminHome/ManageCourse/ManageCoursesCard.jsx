...
const ManageCoursesCard = ({classes}) => {
    const { course, img, price, instructorName, instructorEmail, seat, studentsEnrolled, status } =
    classes;
  return (
    <div className="hero w-[800px] bg-base-200">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div className="space-y-2 ml-5">
          ...
          <button className="btn btn-primary bg-blue-500 mr-2">Approve</button>
          <button className="btn btn-primary bg-blue-500 mr-2">Deny</button>
